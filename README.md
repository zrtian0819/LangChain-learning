...
完成這個專案，你將掌握現代 AI 應用開發的完整工作流程：

### 1. 基礎建設 🏗️
- 設定本地 Ollama LLM 環境
- 整合 LangChain 與 TypeScript
- 建立 Service 層架構（單例模式）

### 2. 核心積木 🧩
- **Prompt Template** - 設計高效的提示詞
- **Model** - 調用本地 AI 模型
- **Output Parser** - 解析和驗證 AI 輸出（Zod Schema）
...
- 向量存儲與語義搜索
- 基於檢索結果的上下文生成
- **解決 AI 幻覺問題** - 讓 AI 只說出可驗證的答案

### 5. 進階概念 🚀
- **Agents** - 讓 AI 具備自主判斷與使用工具的能力
- 多步驟推理與決策
- 與外部系統的集成
...
3. **nomic-embed-text 模型** - 用於 RAG 的文本向量化模型
